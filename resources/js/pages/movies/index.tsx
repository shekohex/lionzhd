...
export default function Movies() {
    ...
    const displayedMovies = isMobile ? infiniteScroll.allData : movies;
            ...
            <ErrorBoundary FallbackComponent={ErrorFallback}>
                <div className="flex flex-col gap-12 p-6">
                    <CategoryFilter
                        ...
                        baseUrl={route('movies')}
                    />

                    {/* Movies Section */}
                    <MediaSection title={currentCategory ? `${currentCategory.name} Movies` : "Latest Movies"}>
                        {isLoading ? (
                            ...
                            <>
                                ...
                                {!isMobile && props.movies?.links && props.movies.links.length > 3 && (
                                    <div className="mb-8">
                                        <DualPagination
                                            links={props.movies.links}
                                            preserveState={true}
